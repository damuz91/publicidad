...
exports.vista_abogado = async (req, res) => {
  try {
    ...
    const marcasPorAbogado = {
      'Maria': ["Naf Naf", "Naf Naf Outlet", "Vivant"],
      'Jota': ["AE", "Gstar"],
      'Valen': ["Brandstore", "Chevignon", "Mango", "Mango Outlet"],
      "Pao": ["Esprit", "Kliiker", "Carrera"],
      "Cami": ["Rifle", "American Brands "],
      "Cata": ["Su+", "Outlet", "Americanino"]
    };
